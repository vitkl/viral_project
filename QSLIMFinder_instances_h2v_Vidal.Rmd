...
```{r comparimotif}
runCompariMotif3(input_file = "./SLIMFinder_Vidal/result/motifs.txt",
...
R.utils::gzip("./SLIMFinder_Vidal/result/comparimotif_with_self.compare.tdt", "./SLIMFinder_Vidal/result/comparimotif_with_self.compare.tdt.gz")
R.utils::gzip("./SLIMFinder_Vidal/result/comparimotif_with_self.compare.xgmml", "./SLIMFinder_Vidal/result/comparimotif_with_self.compare.xgmml.gz")
```
...
filename = paste0("./processed_data_files/QSLIMFinder_instances_h2v_Vidal_clust",format(Sys.Date(), "%Y%m"),".RData")
