...
all_viral_interaction = interSpeciesInteractome(MITABdata = IntAct,
                                                taxid1 = 9606, taxid2 = 10239, database = "IntActFTP", format = "tab27",
                                        clean = TRUE, protein_only = TRUE, directory = "./data_files/", releaseORdate = "2017Nov13")
```
