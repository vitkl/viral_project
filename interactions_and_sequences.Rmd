...
if [ -e ./processed_data_files/all_human_viral_protein_domains.gff3 ]
then
...
gzip ./processed_data_files/all_human_viral_protein_domains.gff3
else
echo "InterProScan has been run before: all_human_viral_protein_domains.gff3 file exists"
fi
```
