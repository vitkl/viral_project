...
if [ -e ./processed_data_files/all_human_viral_protein_domains092017.gff3 ]
then
...
echo "InterProScan has been run before: all_human_viral_protein_domains092017.gff3 file exists"
fi
```
