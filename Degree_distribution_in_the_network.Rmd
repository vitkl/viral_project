...
plotHumanViralDegree = function(degree_distributions, y_text = 2, median_text_size = 5.5, flip_grid = F){
...
plotHumanViralDegree(degree_distributions, y_text = 1, median_text_size = 7)
plotHumanViralDegree(degree_distributions, y_text = 1, median_text_size = 7, flip_grid = T)
```
