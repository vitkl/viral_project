...
time = proc.time()
res = permuteCount(data, select_nodes = NULL)
proc.time() - time
...
enrichment_justfreq = runningTestEnrichment(res, rank_by = "observed_statistic", name = "domain count among interactors of a viral protein, frequency")
