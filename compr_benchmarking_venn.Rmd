...
```{r MOD_LIG_DOC_top_domain, eval=FALSE}
...
```{r protein_domain_motif_protein_network, eval=TRUE}
...
fwrite(IntAct_filt_hum_dom_net, "./results_w_human_dom/IntAct_filt_hum_dom_net_motif_domain_readable.tsv", sep = "\t")
...
fwrite(unique(IntAct_filt_hum_dom_net[,.(Pattern)]), "./results_w_human_dom/IntAct_filt_hum_dom_net_patterns.tsv", sep = "\t")
