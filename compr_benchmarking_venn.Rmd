...
plotVenn = function(res, ...){
    ...
    venn = editGrob(venn, paste0(venn[["childrenOrder"]][7]),
                    ...
                    grep = T)
    venn = editGrob(venn, paste0(venn[["childrenOrder"]][5]),
...
plotAnnotVenn = function(res, main = "", sub = "",
    ...
    annotated_venn = plotVenn(res, fontfamily = fontfamily, cex = cex, cat.cex = cat.cex)
    if(sub != "") {
...
figureVenn = function(filter_by_domain_data = NULL,
    ...
    IntAct_grob = textGrob("including all human data (IntAct)",
                           gp=gpar(fontsize=25, fontfamily = "serif",
                                   lineheight = 1.4, ...))
    ...
    if(main != ""){
        main_grob = textGrob(main,
                          gp=gpar(fontsize=27, fontfamily = "serif",
                                  lineheight = 1, ...))
...
#####################################################################################
replotFigureVenn = function(figure, main, ...){
    IntAct_grob = textGrob("including all human data (IntAct)",
                           gp=gpar(fontsize=24, fontfamily = "serif",
                                   lineheight = 1, ...))
    viral_grob = textGrob("only viral-human data",
                          gp=gpar(fontsize=24, fontfamily = "serif",
                                  lineheight = 1, ...))
...
figure = figureVenn(filter_by_domain_data = NULL,
...
figure2 = replotFigureVenn(figure,
                 main = "")
ggsave(filename = "Venn_not_filtered_MOD_LIG_DOC.svg", plot = figure2$big_plot_text,
       device = "svg", width = 12.79787, height = 11.60638, units = "in")
#grid.newpage()
#grid.draw(figure2$big_plot_text)

figure_filtered = figureVenn(filter_by_domain_data = "p.value < 0.5",
                             main = "human network searched for motifs present in viral proteins (filtered by domain)",
                             motif_pval_tags = c("lenient cutoff", "optimal cutoff", "stringent cutoff"),
                             datasets = datasets)
figure_filtered2 = replotFigureVenn(figure_filtered,
                 main = "")
ggsave(filename = "Venn_filtered_MOD_LIG_DOC.svg", plot = figure_filtered2$big_plot_text,
       device = "svg", width = 12.79787, height = 11.60638, units = "in")
#grid.newpage()
...
figure2 = replotFigureVenn(figure,
                 main = "")
ggsave(filename = "Venn_not_filtered_MOD_LIG_DOC_DEG_CLV.svg", plot = figure2$big_plot_text,
       device = "svg", width = 12.79787, height = 11.60638, units = "in")
#grid.newpage()
#grid.draw(figure2$big_plot_text)
...
figure_filtered2 = replotFigureVenn(figure_filtered,
                 main = "")
ggsave(filename = "Venn_filtered_MOD_LIG_DOC_DEG_CLV.svg", plot = figure_filtered2$big_plot_text,
       device = "svg", width = 12.79787, height = 11.60638, units = "in")
#grid.newpage()
#grid.draw(figure_filtered2$big_plot_text)
...
figure2 = replotFigureVenn(figure,
                 main = "")
ggsave(filename = "Venn_not_filtered_MOD_LIG_DOC_DEG_CLV_TRG.svg", plot = figure2$big_plot_text,
       device = "svg", width = 12.79787, height = 11.60638, units = "in")
#grid.newpage()
#grid.draw(figure2$big_plot_text)
...
figure_filtered2 = replotFigureVenn(figure_filtered,
                 main = "")
ggsave(filename = "Venn_filtered_MOD_LIG_DOC_DEG_CLV_TRG.svg", plot = figure_filtered2$big_plot_text,
       device = "svg", width = 12.79787, height = 11.60638, units = "in")
#grid.newpage()
#grid.draw(figure_filtered2$big_plot_text)
#####################################################################################
