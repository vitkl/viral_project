...
- BioPlex  
- randomised_BioPlex  
- randomised_all_viral_interaction  
...
all_viral_interaction_BioPlex3cloudfixF = copy(all_viral_interaction3cloudfixF)
all_viral_interaction_BioPlex3cloudfixF$data$IDs_interactor_A = gsub("-[[:digit:]]+$","",
                                                            all_viral_interaction_BioPlex3cloudfixF$data$IDs_interactor_A)
all_viral_interaction_BioPlex3cloudfixF$data$pair_id = paste0(all_viral_interaction_BioPlex3cloudfixF$data$IDs_interactor_A,
                                                     "|", all_viral_interaction_BioPlex3cloudfixF$data$IDs_interactor_B)
all_viral_interaction_BioPlex3cloudfixF$data = unique(all_viral_interaction_BioPlex3cloudfixF$data)

# human-human
Full_IntAct3cloudfixF = fullInteractome(taxid = 9606, database = "IntActFTP", format = "tab27",
                              clean = TRUE, protein_only = TRUE,
                              MITABdata = IntAct, directory = "./data_files/",
                                                releaseORdate = "2017Nov13")

Vidal3cloudfixF = subsetMITABbyPMIDs(MITABdata = Full_IntAct3cloudfixF,
                           PMIDs = c("25416956", "unassigned1304"))
BioPlex3cloudfixF = loadBioplex(dir = "./data_files/",
...
```r
randomised_BioPlex3cloudfixF = copy(BioPlex3cloudfixF)
randomised_BioPlex3cloudfixF$data$Publication_Identifiers = NA
randomised_BioPlex3cloudfixF$data$Confidence_values = NA
randomised_BioPlex3cloudfixF$data = unique(randomised_BioPlex3cloudfixF$data)
set.seed(1)
randomised_BioPlex3cloudfixF$data$IDs_interactor_B = randomised_BioPlex3cloudfixF$data$IDs_interactor_B[sample.int(length(randomised_BioPlex3cloudfixF$data$IDs_interactor_B))]
randomised_BioPlex3cloudfixF$data$pair_id = paste0(randomised_BioPlex3cloudfixF$data$IDs_interactor_A, "|", randomised_BioPlex3cloudfixF$data$IDs_interactor_B)

randomised_all_viral_interaction3cloudfixF = copy(all_viral_interaction3cloudfixF)
randomised_all_viral_interaction3cloudfixF$data$Publication_Identifiers = NA
randomised_all_viral_interaction3cloudfixF$data$Confidence_values = NA
randomised_all_viral_interaction3cloudfixF$data = unique(randomised_all_viral_interaction3cloudfixF$data)
set.seed(1)
randomised_all_viral_interaction3cloudfixF$data$IDs_interactor_B = randomised_all_viral_interaction3cloudfixF$data$IDs_interactor_B[sample.int(length(randomised_all_viral_interaction3cloudfixF$data$IDs_interactor_B))]
randomised_all_viral_interaction3cloudfixF$data$pair_id = paste0(randomised_all_viral_interaction3cloudfixF$data$IDs_interactor_A, "|", randomised_all_viral_interaction3cloudfixF$data$IDs_interactor_B)
```
...
myPPInetwork2SLIMFinder = function(dataset_name = "SLIMFinder", slimlen = 5, maxwild = 2,
    ...
    PPInetwork2SLIMFinder(dataset_name = dataset_name,
                          ...
                          options = paste0("dismask=T consmask=F cloudfix=F probcut=0.3 minwild=0 maxwild=",maxwild," slimlen=",slimlen," alphahelix=F maxseq=800 savespace=0 iuchdir=T extras=2"),
...
datasets = c("Full_IntAct3cloudfixF", "all_viral_interaction3cloudfixF","BioPlex3cloudfixF", "randomised_BioPlex3cloudfixF", "randomised_all_viral_interaction3cloudfixF") # "Vidal3cloudfixF"
...
# assign correct query dataset
dataset_names[grepl("BioPlex",datasets), query_dataset := "all_viral_interaction_BioPlex3cloudfixF"]
dataset_names[!grepl("BioPlex",datasets), query_dataset := "all_viral_interaction3cloudfixF"]
dataset_names[grepl("randomised_all_viral_interaction3cloudfixF",datasets), query_dataset := "randomised_all_viral_interaction3cloudfixF"]
...
if(nrow(dataset_names_not_done) >= 1){
    ...
    R_data = parSapplyLB(cl = cl, X = 1:nrow(dataset_names_not_done), FUN = function(i){
        R_data_name = myPPInetwork2SLIMFinder(dataset_name = dataset_names_not_done$dataset_names[i], 
...
```
## [1] "./processed_data_files/QSLIMFinder_instances_h2v_qslimfinder.Full_IntAct3cloudfixF.FALSE_clust201804.RData.zip"                     
## [2] "./processed_data_files/QSLIMFinder_instances_h2v_qslimfinder.all_viral_interaction3cloudfixF.FALSE_clust201804.RData.zip"           
## [3] "./processed_data_files/QSLIMFinder_instances_h2v_qslimfinder.BioPlex3cloudfixF.FALSE_clust201804.RData.zip"                         
## [4] "./processed_data_files/QSLIMFinder_instances_h2v_qslimfinder.randomised_BioPlex3cloudfixF.FALSE_clust201804.RData.zip"              
## [5] "./processed_data_files/QSLIMFinder_instances_h2v_qslimfinder.randomised_all_viral_interaction3cloudfixF.FALSE_clust201804.RData.zip"
```
