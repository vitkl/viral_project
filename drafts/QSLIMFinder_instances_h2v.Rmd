...
dataset_name = "SLIMFinder" # refer to MItools::mBenchmarkMotifs
...
options = "dismask=T consmask=F cloudfix=T probcut=0.3 iuchdir=T maxseq=1500"
...
QSLIMFinderCommand(file_list = forSLIMFinder_file_list, analysis_type = analysis_type)
