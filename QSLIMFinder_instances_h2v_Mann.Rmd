---
title: 'QSLIMFinder: domain instances, human to search (Mann data only), viral to filter'
...
```{r comparimotif}
runCompariMotif3(input_file = "./SLIMFinder_Mann/result/motifs.txt",
...
R.utils::gzip("./SLIMFinder_Mann/result/comparimotif_with_self.compare.tdt", "./SLIMFinder_Mann/result/comparimotif_with_self.compare.tdt.gz")
R.utils::gzip("./SLIMFinder_Mann/result/comparimotif_with_self.compare.xgmml", "./SLIMFinder_Mann/result/comparimotif_with_self.compare.xgmml.gz")
```
...
filename = paste0("./processed_data_files/QSLIMFinder_instances_h2v_Mann_clust",format(Sys.Date(), "%Y%m"),".RData")
