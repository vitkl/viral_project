...
R.utils::gzip("./SLIMFinder/result/comparimotif_with_self.compare.tdt", "./SLIMFinder/result/comparimotif_with_self.compare.tdt.gz")
R.utils::gzip("./SLIMFinder/result/comparimotif_with_self.compare.xgmml", "./SLIMFinder/result/comparimotif_with_self.compare.xgmml.gz")
```
...
filename = paste0("./processed_data_files/QSLIMFinder_instances_h2v_clust",format(Sys.Date(), "%Y%m"),".RData")
