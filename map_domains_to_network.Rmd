...
InterProScan_domains_list = split(InterProScan_domains, data.table(seqnames(InterProScan_domains), InterProScan_domains$Dbxref))
Nrow = length(InterProScan_domains_list[[3]])
reduce(InterProScan_domains_list[[3]])
```
