...
res_dir="./SLIMFinder/QSLIMFinder/bjob"
res_path=$res_dir"bjob_res.csv"
while IFS=$'\t' read -r data query;
do
bsub -n 1 -q research-rh7 -M 16000 -R "rusage[mem=16000]" python $QSLIMFinder blast+path=$BLAST_PATH iupath=$IUPred_PATH resdir=$res_dir resfile=$res_path seqin=$data query=$query dismask=T consmask=T cloudfix=F probcut=0.5
done < ./SLIMFinder/filelist.txt
```
