...
filter_by_domain_data_print = gsub("<*","",filter_by_domain_data_print)
filter_by_domain_data_print = gsub("=*","",filter_by_domain_data_print)
filename = paste0("./processed_data_files/compr_benchmarking_strategIntVid",format(Sys.Date(), "%Y%m"),"_",paste0(motif_types,collapse = "_"),"_",neg_set,"_",query_predictor_col,"_", filter_by_domain_data_print,"_type_", measure1, measure2,".RData")
