...
```r
N_negative_sets = 200
motif_types = c("DOC", "DEG", "CLV", "TRG") # "MOD", "LIG" / "DOC", "DEG", "CLV", "TRG"
...
```
## GRanges object with 0 ranges and 55 metadata columns:
##    seqnames    ranges strand |       query interacts_with     Dataset
##       <Rle> <IRanges>  <Rle> | <character>    <character> <character>
##         Rank     Pattern       Sig  Prot_Len       Match     Variant
##    <integer> <character> <numeric> <integer> <character> <character>
##     MisMatch      Desc      PepSeq   PepDesign     Masking       Build
##    <integer> <logical> <character> <character> <character> <character>
##         Chance    SeqNum     UPNum     AANum    MotNum        IC       Occ
##    <character> <integer> <integer> <integer> <integer> <numeric> <integer>
##      Support        UP     ExpUP      Prob     Cloud  CloudSeq   CloudUP
...
##    motif_occ_per_domain normalised_motif_occ_per_domain domain_motif_pval
...
##  MItools              * 0.1.36   2017-12-08 local (vitkl/MItools@NA)
