...
justFisherdata = resFISHERodds$data_with_pval
...
resJustFISHER[, p.value := observed_statistic]
resJustFISHER[, observed_statistic := odds_ratio]
resJustFISHER[, fdr_pval := p.adjust(p.value, method = "fdr")]
resJustFISHER005 = resJustFISHER[fdr_pval < 0.05,]
resJustFISHER01 = resJustFISHER[fdr_pval < 0.1,]
resJustFISHER001 = resJustFISHER[fdr_pval < 0.01,]
```
