...
time = proc.time()
resFISHERpval = permuteFisherTest(data, select_nodes = NULL)
proc.time() - time
...
proc.time() - time
plot(resFISHERodds, main = "Fisher test P-value: all proteins and domains")
...
proc.time() - time
plot(resFISHERoddsBig, main = "Fisher test P-value: all proteins and domains")
